...
describe("Chests Store", () => {
  ...
  it("should update via update function", () => {
    chests.set([
      { id: 1, name: "Chest A", created_at: "2024-01-01", updated_at: null },
    ]);
    chests.update((list) => [
      ...list,
      { id: 2, name: "Chest B", created_at: "2024-01-02", updated_at: null },
    ]);
  ...
  it("should reset to empty", () => {
    chests.set([
      { id: 1, name: "X", created_at: "2024-01-01", updated_at: null },
    ]);
    chests.set([]);
